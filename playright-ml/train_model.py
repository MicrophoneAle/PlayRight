...
class PianoFingeringDataset(Dataset):
    def __init__(self, csv_file, seq_length=16):
        ...
        # This turns 'Hand_Assignment' into 'Hand_Assignment_Right' and 'Hand_Assignment_Left' (1s and 0s)
        ...
        self.input_size = self.features.shape[1] # We need this number for the Neural Network
...
def train_model():
    ...
    # 3. Initialize Model (Dynamically passing the number of features generated by pandas)
    ...
    print("\nTraining complete! Next up: ONNX Export.")
