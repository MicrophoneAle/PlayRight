/** Multi-system fixture for sheet scroll E2E (narrow viewport wraps systems). */
export const E2E_SCROLL_MUSICXML = `<?xml version="1.0" encoding="UTF-8"?>
<score-partwise version="3.1">
  <part-list>
    <score-part id="P1">
      <part-name>E2E Scroll</part-name>
    </score-part>
  </part-list>
  <part id="P1">
    <measure number="1">
