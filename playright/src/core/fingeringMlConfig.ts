 ...
 * rule-based DP, and the model is not even loaded then.
 *
 * 150 was chosen from the 2026-07-03 sweep of the PIG-trained emission model
 ...
 * constraints, because the DP owns transitions.
 */
